...
prompt_infisical_shell() {
  if [[ -n "$SECRET_ENV_TYPE" ]]; then
    case "$SECRET_ENV_TYPE" in
        "dev")
            prompt_segment green black $SECRET_ENV_NAME
            ;;
        "staging")
            prompt_segment yellow black $SECRET_ENV_NAME
            ;;
        "prod")
            prompt_segment red black $SECRET_ENV_NAME
            ;;
        *)
            prompt_segment cyan black $SECRET_ENV_NAME
            ;;
    esac
  fi
}
